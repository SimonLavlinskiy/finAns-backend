...
func TestPlannedExpenseService_ValidateAndBuild_EmptyTitle(t *testing.T) {
	...
	_, err := svc.validateAndBuild(context.Background(), 0, "", nil, nil, nil, "medium", nil, nil, int64(1))
	if err == nil {
...
func TestPlannedExpenseService_ValidateAndBuild_BadPriority(t *testing.T) {
	svc := &PlannedExpenseService{}
	title := "Наушники"
	_, err := svc.validateAndBuild(context.Background(), 0, title, nil, nil, nil, "urgent", nil, nil, int64(1))
	if err == nil {
...
func TestPlannedExpenseService_ValidateAndBuild_NegativeCost(t *testing.T) {
	svc := &PlannedExpenseService{}
	cost := int64(-100)
	_, err := svc.validateAndBuild(context.Background(), 0, "Наушники", &cost, nil, nil, "medium", nil, nil, int64(1))
	if err == nil {
...
func TestPlannedExpenseService_ValidateAndBuild_BadDueDate(t *testing.T) {
	svc := &PlannedExpenseService{}
	bad := "not-a-date"
	_, err := svc.validateAndBuild(context.Background(), 0, "Наушники", nil, &bad, nil, "medium", nil, nil, int64(1))
	if err == nil {
...
func TestPlannedExpenseService_ValidateAndBuild_MissingCategory(t *testing.T) {
	svc := &PlannedExpenseService{}
	_, err := svc.validateAndBuild(context.Background(), 0, "Наушники", nil, nil, nil, "medium", nil, nil, int64(1))
	if err == nil {
